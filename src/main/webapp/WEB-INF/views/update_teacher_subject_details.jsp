...
<html>
    <head>
        ...
        <title>Teacher Subject-update details Page</title>
            ...
            <div class="container mt-5">
                <div class="row-sm">
                    <div class="col-md-6">
                        ...
                        <form  action="/student_management_app/subject/getUpdateTeacherSubjectData" class="mt-5" onsubmit="return  validation()" method="post">
