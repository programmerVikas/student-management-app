...
<html>
    <head>
        ...
        <title>Teacher Subject_details Page</title>
                    ...
                    <tbody>
                        <c:forEach var="data" items="${data}" varStatus="loopCounter">
                                ...
                                <tr class="bg-info text-light">
                                    ...
                                    <td><a href="deleteTeacherSubjectData/${data.id}"><i class="fa fa-trash text-danger" aria-hidden="true" style="font-size: 25px;" title="Delete"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp;
                                        <a href="getSingleTeacherSubjectData/${data.id}"><i class="fa fa-pencil text-light" aria-hidden="true" style="font-size: 20px;" title="Edit"></i></a></td>
                                </tr>                            
