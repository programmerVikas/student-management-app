                    ...
                    <tbody>
                        ...
                        <c:forEach var="feedata" items="${feedata}" varStatus="loopCounter">
                            ...
                            <tr class="bg-info text-light">
                                ...
                                <td><a href="deleteData/${feedata.id}"><i class="fa fa-trash text-danger" aria-hidden="true" style="font-size: 25px;" title="Delete"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp;
                                    <a href="getSingleData/${feedata.id}"><i class="fa fa-pencil text-light" aria-hidden="true" style="font-size: 20px;" title="Edit"></i></a></td>
