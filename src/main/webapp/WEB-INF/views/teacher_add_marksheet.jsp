...
<html>
    <head>
        ...
        <title>Teacher Add mark-sheet Page</title>
            ...
            <div class="container mt-5 mb-5">
                <div class="row-sm">
                    <div class=" col-md-6 ">
                        ...
                        <form action="/student_management_app/marksheet/saveMark" method="post" class="mt-5" onsubmit="return validation()">
                            <div class="form-row">                                        
                                <div class="form-group col-md-6 ">
                                    <label for="inputState">Select Student :-</label>
                                    <select id="std_name" class="form-control" name="student_name">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Prn no.</label>
                                    <input type="text" class="form-control"  name="prn_no" id="prnId" placeholder="Enter prn no.">
                            ...
                            <div class="form-row ">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control"  name="first_Subject_Marks" id="marksId" placeholder="Enter marks here....">
                            ...
                            <div class="form-row ">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Marks(grade/number/cgp).</label>
                                    <input type="text" class="form-control"  name="second_Subject_Marks" id="marksId" placeholder="Enter marks here....">
                                    <span class="text-warning" id="marks"></span>
                                </div>
                            </div>         
                            ...
                            <div class="form-row ">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Marks(grade/number/cgp).</label>
                                    <input type="text" class="form-control"  name="third_Subject_Marks" id="marksId" placeholder="Enter marks here....">
                                    <span class="text-warning" id="marks"></span>
                                </div>
                            </div>      
                            ...
                            <div class="form-row ">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Marks(grade/number/cgp).</label>
                                    <input type="text" class="form-control"  name="fourth_Subject_Marks" id="marksId" placeholder="Enter marks here....">
                                    <span class="text-warning" id="marks"></span>
                                </div>
                            </div>      
                            ...
                            <div class="form-row ">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Marks(grade/number/cgp).</label>
                                    <input type="text" class="form-control"  name="fifth_Subject_Marks" id="marksId" placeholder="Enter marks here....">
                                    <span class="text-warning" id="marks"></span>
                                </div>
                            </div>     
                            ...
                            <div class="form-row  border border-primary mt-3 bg-info">
                                <div class="form-group col-md-6">                                      
                                  ...
                                  <div class="form-group col-md-6">                                      
                                    ...
                                    <input type="text" class="form-control" name="cgpa" placeholder="Enter total cgpa value">                        
                                </div>      
                            </div>     
