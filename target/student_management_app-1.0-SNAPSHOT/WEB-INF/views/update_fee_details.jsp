...
<html>
    <head>
        ...
        <title>update fee details Page</title>
    ...
    <div class="section  mb-5">  
        ...
        <div class="container mt-5">
            <div class="row-sm">
                <div class="col-md-8">
                    ...
                    <form action="/student_management_app/fee/updateData" method="post" class="mt-5" onsubmit="return validation()">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <select id="fee_std" class="form-control" name="student_name">
                                    <option selected>${data.student_name}</option>
                                    <c:forEach var="data" items="${signdata}">   
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"  name="prn_no" id="prn_id" placeholder="Enter Your ID" value="${data.prn_no}">
                        ...
                        <div class="form-row mt-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="fee_year" class="form-control" name="course_year">
                                    <option selected>${data.course_year}</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control"  name="fee_date" id="fee_date" value="${data.fee_date}">
                        ...
                        <div class="form-row mt-4 mb-5">
                            <div class="col-md-6">
                                <label for="inputState"><h4>Here feel new Amount</h4></label>
                                <input type="number" class="form-control" id="newAmount"  name="new_amount" placeholder="Enter your new amount" value="0">                                
                            </div>
                        ...
                        <div class="form-row mt-4">
                            <div class="col-md-6">
                                <label for="inputState">Total Paid Amount</label>
                                <input type="number" class="form-control"  name="recent_amount" id="fee_amt" placeholder="Enter amount" value="${data.recent_amount}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control"  name="total_amount" id="fee_total" placeholder="Enter total amount" value="${data.total_amount}">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 ">
                                ...
                                <input type="text" class="form-control "  name="due_fee" id="fee_due" value="${data.due_fee}">                              
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            function validation() {
                ...
                var sum =parseInt(newAmount) + parseInt(recentamt);
               recentamt = document.getElementById("fee_amt").value = sum;
               
               
                var msum = totalFee - recentamt;
                document.getElementById("fee_due").value = msum;   
