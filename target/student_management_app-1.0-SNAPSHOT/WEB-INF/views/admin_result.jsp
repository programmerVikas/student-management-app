                    ...
                    <tbody class="text-center">
                        <c:forEach var="data" items="${data}" varStatus="loopCounter">
                          ...
                          <th scope="row"><c:out value="${loopCounter.count}"/></th>                             
                                ...
                                <td><a href="/student_management_app/marksheet/deleteAdminMarkValue/${data.id}"><i class="fa fa-trash text-danger" aria-hidden="true" style="font-size: 25px;" title="Delete"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp;
                                    <a href="/student_management_app/marksheet/getAdminSingleMarkData/${data.id}"><i class="fa fa-pencil text-light" aria-hidden="true" style="font-size: 20px;" title="Edit"></i></a></td>
                            </tr>
