...
<html>
    <head>
        ...
        <title>Teacher Add Subject Page</title>
            ...
            <div class="container mt-5">
                <div class="row-sm">
                    <div class="col-md-6">
                        ...
                        <form  action="/student_management_app/subject/teacherSaveSubject" class="mt-5" onsubmit="return  validation()" method="post">
                            <div class="form-row">
                                <div class="form-group col-md-8 ">
                                    <label for="inputState">Subject</label>
                                    <input type="text" class="form-control"  name="subject" id="sub" placeholder="Enter subject name">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-8 ">
                                    ...
                                    <textarea class="form-control"  name="subject_title" id="subtitle" placeholder="Enter subject title"></textarea>
